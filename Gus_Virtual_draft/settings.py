"""
Django settings for Gus_Virtual_draft project.
...
SECRET_KEY = '2-v6(76bzdd_yu&7louwm@ztr7%)y#i+zmr7)e2j9^y8s)2kbv'
...
ROOT_URLCONF = 'Gus_Virtual_draft.urls'
...
WSGI_APPLICATION = 'Gus_Virtual_draft.wsgi.application'
